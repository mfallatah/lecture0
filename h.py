...
print(new_list)
_________________________________Global , local Non Global ___________________________
...
c = 1 # Global 
def add():
   global c # اذا نبغى نسوي عملية على عنصر عام لازم نحط قلمة قلوبال ونحط اسم العنصر داخل الدالة اللي حانستخدمه فيها
   c= c+10 # هذي العملية ما تتنفذ اذا ما اضفنا السطر اللي فوق لكن لو طبعنا قيمة سي لوحدها تتنفذ
   print(c)
add()
print(c)
"""
...
import rwaq
print(rwaq.a)# rwaq  اسم ملف بايثن انشئته وحفظته في نفس المجلد سويت له استدعاء وامرته يطبع قيمة a ونحط اسم الملف قبل الملف اللي نبغى نطبعه
# بامكاننا التعديل على القيم اما عن طريق نفس الملف او نسوي ملف اخر ونكتب مثلا ss.a = "CDF" ولما نطبعها راح تطبع القيمة الجديدةونسوي امبورت لمللف اللي عملت التعديل عليه
"""
"""
def foo():
	x = 20
	def bar():
		global x
		x = 25
	print("befor caling bar", x)
	print("calling bar now")
	bar() # Global x = 25
	print("after calling", x)
foo() # # هنا عشان على مستوى البرنامج كله يطبع قيمة اكس 25
print("x in main ", x)
# قلوبال تنطبع على مستوى البرنامج كله لكن مالها علاقة بالدالة وهذه نقطة مهمة 

"""
"""
_____________ MODULE ____________________
import math as m 
# غيرنا اسم المكتبة من math to m 
#عند الاستدعاء بدل ما اكتب اسم المكتبة ماث اكتب حرف الام او الاسم اللي سميتها
print(m.pi)
# كذا حايطبع قيمة الباي 3.14
from math import pi
# السطر اللي فوق استدعى الباي من المكتبة وهذا فيه حفاظ على الذاكرة بدل ماينزل المكتبة كاملة 
# مثال
from math import pi
print(pi)
from math import*
# السطر اللي فوق يستدعي كل المكتبة لكن في الاستدعاء مايحتاج اكتب اسمالمكتبة قبل الااة مثلا
print(pi)
# لكن لو استدعينا المكتبة بالشكل المعاتاد import maath 
print(math.pi) # يعني لازم نحط اسم المكتبة قبل الاداة
____________ Package _________________
